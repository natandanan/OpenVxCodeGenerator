...
int main( int argc, char * argv[] )
{
	...
	vx_image output_colorConvert_RGB= vxCreateVirtualImage(graph, 0, 0, VX_DF_IMAGE_RGB);

	vxColorConvertNode(graph, input, output_colorConvert_RGB);
	vxColorConvertNode(graph, output_colorConvert_RGB, output);
